...
@CucumberOptions(features={"src/test/java/features/customerAPI.feature"},glue={"stepDefinition"},plugin={"pretty","html:HTML_Reports/"})

public class customerAPIRunner extends TestBase{		
